...
$(function () {
    ...
    window.requestAnimationFrame(function () {
        window.antaresEvents.emit('dt_reinit', $('#dataTableBuilder1'), $params.options);
        window.requestAnimationFrame(function () {
            window.antaresEvents.emit('dt_reinit', $('#dataTableBuilder2'), $params.options);
            window.requestAnimationFrame(function () {
                window.antaresEvents.emit('dt_reinit', $('#dataTableBuilder3'), $params.options);
                window.requestAnimationFrame(function () {
                    window.antaresEvents.emit('dt_reinit', $('#dataTableBuilder4'), $params.options);
                    window.requestAnimationFrame(function () {
                        window.antaresEvents.emit('dt_reinit', $('#dataTableBuilder5'), $params.options);
                        window.requestAnimationFrame(function () {
                            window.antaresEvents.emit('dt_reinit', $('#dataTableBuilder6'), $params.options);
                        });
                    });
                });
            });
