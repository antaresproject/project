...
/***/ 135:
/*!***************************************************!*\
  !*** ./_src/js/external/modified/context_menu.js ***!
  \***************************************************/
...
(function (factory) {
    if (true) {
        ...
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ 21)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
/***/ 136:
/*!********************************************************************************************!*\
  !*** ./node_modules/script-loader!./node_modules/datatables/media/js/jquery.dataTables.js ***!
  \********************************************************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! !./node_modules/script-loader/addScript.js */ 2)(__webpack_require__(/*! !./node_modules/raw-loader!./node_modules/datatables/media/js/jquery.dataTables.js */ 137))

/***/ }),

/***/ 137:
/*!*****************************************************************************************!*\
  !*** ./node_modules/raw-loader!./node_modules/datatables/media/js/jquery.dataTables.js ***!
  \*****************************************************************************************/
/*! no static exports found */
/*! all exports used */
...
var AntaresDatatablesFilters = {
    ...
    filtersSwiper: function filtersSwiper() {
        ...
        enquire.register('screen and (min-width: 1351px) and (max-width: 1499px)', {
            match: function match() {
                var gsWidth = $('.card-datatables').closest('.grid-stack-item').attr('data-gs-width');
                        ...
                        match: function match() {
                            setTimeout(function () {
                                $('.drop-target').on('click', function () {
                                    var openDrop = $('.this-is-dropczyk--out.drop-element.drop-enabled');
                                    var leftForDrop = openDrop.offset().left;
                                    if (leftForDrop > 30) {
        ...
        $('.swiper-filters--box:not(.swiper-filters--no-active)').closest('.card').mousedown(function () {
    ...
    addFilter: function addFilter() {
        ...
        function addTemplateNumber(typeFilter, minVal, maxVal, dataMin, dataMax, tooltipName) {
            $('.card-filters--swiper').append('<div class="swiper-slide">' + '<div class="filter filter-type--number this-is-dropczyk" data-type="' + typeFilter + '">' + '<div class="card-filter__sgl ddown__init dropjs-target" data-filter-type="ammount" data-filter-value="' + minVal + ' - ' + maxVal + '" >' + //data-tooltip-inline="Serv"
            '<span>' + minVal + ' - ' + maxVal + '</span>' + '<i class="zmdi zmdi-close filter-close"></i>' + '</div>' + '<div class="dropjs-wrapper">' + '<div class="filter-content filter--number" data-type="' + typeFilter + '" data-min="' + dataMin + '" data-max="' + dataMax + '">' + '<span>Filter By ' + typeFilter.charAt(0).toUpperCase() + typeFilter.substr(1) + '</span>' + '<div class="slider-box">' + '<div class="filter-slider ui-slider--minimal" data-slider-range-filter="true"></div>' + '</div>' + '<div class="form-block ff-rnw  spinners-box">' + '<div class="spinner-basic">' + '<input class="filter-spinner filter-spinner-mode-min filter-spinner--min" type="number" value="' + minVal + '" data-spinner="true" name="value">' + '</div>' + '<span class="ml16 mr16"> - </span>' + '<div class="spinner-basic">' + '<input class="filter-spinner filter-spinner-mode-max filter-spinner--max" type="number" value="' + maxVal + '" data-spinner="true" name="value2">' + '</div>' + '</div>' + '<a class="btn btn--md btn--default mdl-js-button mdl-js-ripple-effect change-filter change-filter--number">Confirm</a>' + '</div>' + '</div>' + '</div>');
        }

        function addTemplateBadge(typeFilter, selectedStatus) {
            var thisSlide = $('.card-filters--swiper');
            thisSlide.append('<div class="swiper-slide">' + '<div class="filter filter-type--badge this-is-dropczyk" data-type="' + typeFilter + '">' + '<div class="card-filter__sgl ddown__init dropjs-target" data-filter-value="' + typeFilter.charAt(0).toUpperCase() + typeFilter.substr(1) + '" >' + //data-tooltip-inline="Serv"
            '<span>' + selectedStatus + '</span>' + '<i class="zmdi zmdi-close filter-close"></i>' + '</div>' + '<div class="dropjs-wrapper">' + '<div class="filter-content filter--badge" data-type="' + typeFilter + '" >' + '<span>Filter By ' + typeFilter.charAt(0).toUpperCase() + typeFilter.substr(1) + '</span>' + '<div class="slider-box">' + '<select name="select" data-selectAR="true" class="select--badge">' + '<option value="Active">Active</option>' + '<option value="Pending">Pending</option>' + '<option value="In space">In space</option>' + '</select>' + '<a  class="btn btn--md btn--default mdl-js-button mdl-js-ripple-effect change-filter change-filter--badge">Confirm</a>' + '</div>' + '</div>' + '</div>');
            for (var i = 0; i < thisSlide.find('.slider-box option').length; i++) {
        ...
        $('.ddown-multi .add-filter').on('click', function () {
            ...
            if (typeFilter === 'services' || typeFilter === 'created') {
                if (typeFilter === 'services') {
                    ...
                    var _countFilter = $('.swiper-filters--box').attr('data-filter-' + typeFilter);
                    if (_countFilter === undefined) {
                        $('.swiper-filters--box').attr('data-filter-' + typeFilter, '1');
                    } else if (_countFilter === '5') {
                        self.filterAlertNumber('error', parent);
                        return false;
                    } else {
                        _countFilter++;
                        $('.swiper-filters--box').attr('data-filter-' + typeFilter, _countFilter);
                    }
                }
    ...
    closeFilter: function closeFilter() {
        ...
        $('.filters .btn-filter--clear-all').click(function () {
            ...
            window.noty($.extend({}, APP.noti.errorFM('lg', 'border'), {
    ...
    editFilter: function editFilter() {
        ...
        $('.change-filter').on('click', function () {
            if ($(this).hasClass('change-filter--number')) {
                ...
                var newSelectStatus = $(this).closest('.slider-box').find('.select2-selection__rendered').attr('title');
                var originTarget = $('.drop-enabled').closest('.this-is-dropczyk');
                var haveSameStatusFilter = false;
                for (var i = 0; i < $('.filter-type--badge').length; i++) {
    ...
    filterAlertNumber: function filterAlertNumber(category, parent, minInp, maxInp, dataMin, dataMax) {
        ...
        if (category === 'error') {
            ...
            window.noty($.extend({}, APP.noti.successFM('lg', 'border'), {
                text: 'Filter Added'
            }));
        } else if (category === 'warning') {
            parent.find('.filter-spinner--min').removeClass('filter-spinner--validation-error');
            parent.find('.filter-spinner--max').removeClass('filter-spinner--validation-error');
            window.noty($.extend({}, APP.noti.warningFM('lg', 'border'), {
                text: 'Filter changed'
            }));
        }
    },
    filterAlertBadge: function filterAlertBadge(category, selectedStatus) {
    ...
    addFilterDT: function addFilterDT(parent) {
    ...
    editFilterDT: function editFilterDT(parent) {
        $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
            var min = parseInt(parent.find('.filter-spinner--min').val(), 10);
            var max = parseInt(parent.find('.filter-spinner--max').val(), 10);
            var age = parseFloat(data[5]) || 0; // use data for the age column
    ...
    showAllRowsDT: function showAllRowsDT() {
...
/***/ 145:
/*!*************************************************!*\
  !*** ./_src/js/components/datatables/gs_fit.js ***!
  \*************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 146:
/*!*******************************************************!*\
  !*** ./_src/js/components/datatables/context_menu.js ***!
  \*******************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
                    ...
                    if ($('html').hasClass('is-mobile') || $('html').hasClass('is-tablet')) {
                        ...
                        $.contextMenu({
                            ...
                            build: function build(trigger, e) {
                                // 'trigger' this is the last element (td:not(.dt-actions)) that is written by the line above (30 line)
...
/***/ 823:
/*!*****************************************************************!*\
  !*** multi ./_src/templates/webpack/views/view_translations.js ***!
  \*****************************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./_src/templates/webpack/views/view_translations.js */824);
...
__webpack_require__(/*! ./../../../js/components/translations/translations_tableView.js */ 825);
__webpack_require__(/*! ./../../../js/components/translations/dropjs.js */ 827);

/***/ }),

/***/ 825:
/*!*******************************************************************!*\
  !*** ./_src/js/components/translations/translations_tableView.js ***!
  \*******************************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
window.autosize = __webpack_require__(/*! ./autosize.js */ 826);

__webpack_require__(/*! ./../../../js/external/modified/context_menu.js */ 135); // css in package
__webpack_require__(/*! script-loader!datatables */ 136);
__webpack_require__(/*! script-loader!datatables.net-responsive */ 138); // no css
__webpack_require__(/*! script-loader!datatables.net-scroller */ 140); // no css
__webpack_require__(/*! script-loader!datatables.net-buttons */ 142); // no css
// APP COMPONENTS:
__webpack_require__(/*! ./../../../js/components/datatables/filters.js */ 144);
__webpack_require__(/*! ./../../../js/components/datatables/gs_fit.js */ 145);
// OUTED BY SERVERSIDE VERSION:
__webpack_require__(/*! ./../../../js/components/datatables/context_menu.js */ 146);
...
(function () {
  var translationsTable = {
    ...
    initTableSearch: function initTableSearch() {
      var self = this;
    ...
    deleteRow: function deleteRow(event) {
      this.translationsTable.row($(event.currentTarget).closest('tr')).remove().draw();
      $('.ps-container').perfectScrollbar('update');
    },
    addCounter: function addCounter() {
      var self = this;
      this.translationsTable.on('order.dt search.dt', function () {
        self.translationsTable.column(0).nodes().each(function (cell, i) {
          cell.innerHTML = i + 1;
        });
      }).draw();
    },
...
/***/ 826:
/*!*****************************************************!*\
  !*** ./_src/js/components/translations/autosize.js ***!
  \*****************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 827:
/*!***************************************************!*\
  !*** ./_src/js/components/translations/dropjs.js ***!
  \***************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var translationsDropJs = exports.translationsDropJs = {
  init: function init() {
    this.dropJS();
  },
  ...
  dropJS: function dropJS() {
    var translationPageID = document.querySelector('.page-translations');

    if (translationPageID == null) {
      return false;
    }

    var translationDrop = new Drop({
