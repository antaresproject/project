...
/***/ 797:
/*!*******************************************************************!*\
  !*** multi ./_src/templates/webpack/views/view_brand_settings.js ***!
  \*******************************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./_src/templates/webpack/views/view_brand_settings.js */798);
...
// EXTERNAL DEPS:
var CodeMirror = __webpack_require__(/*! codemirror/lib/codemirror.js */ 16);
window.CodeMirror = CodeMirror;

__webpack_require__(/*! ./../../../js/external/modified/codemirror_autoformat.js */ 799);
__webpack_require__(/*! codemirror/mode/css/css.js */ 331);
__webpack_require__(/*! codemirror/mode/xml/xml.js */ 800);
__webpack_require__(/*! codemirror/addon/edit/closebrackets.js */ 801);
__webpack_require__(/*! codemirror/addon/edit/matchbrackets.js */ 332);
__webpack_require__(/*! codemirror/addon/edit/matchtags.js */ 802);
__webpack_require__(/*! codemirror/addon/fold/xml-fold.js */ 333);
__webpack_require__(/*! codemirror/addon/selection/active-line.js */ 803);
__webpack_require__(/*! codemirror/addon/scroll/simplescrollbars.js */ 804);
__webpack_require__(/*! codemirror/addon/hint/css-hint.js */ 805);
__webpack_require__(/*! codemirror/addon/hint/html-hint.js */ 806);
__webpack_require__(/*! codemirror/keymap/sublime.js */ 808);

// components:
__webpack_require__(/*! ./../../../js/components/brand_colors/brand_colors.js */ 810);
__webpack_require__(/*! ./../../../js/components/brand_form/brand_form.js */ 814);

/***/ }),

/***/ 799:
/*!************************************************************!*\
  !*** ./_src/js/external/modified/codemirror_autoformat.js ***!
  \************************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(/*! ../../lib/codemirror */ 16), __webpack_require__(/*! ../fold/xml-fold */ 333));
  else if (typeof define == "function" && define.amd) // AMD
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(/*! ../../lib/codemirror */ 16), __webpack_require__(/*! ../../mode/css/css */ 331));
  else if (typeof define == "function" && define.amd) // AMD
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(/*! ../../lib/codemirror */ 16), __webpack_require__(/*! ./xml-hint */ 807));
  else if (typeof define == "function" && define.amd) // AMD
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(/*! ../lib/codemirror */ 16), __webpack_require__(/*! ../addon/search/searchcursor */ 809), __webpack_require__(/*! ../addon/edit/matchbrackets */ 332));
  else if (typeof define == "function" && define.amd) // AMD
...
/***/ 810:
/*!*********************************************************!*\
  !*** ./_src/js/components/brand_colors/brand_colors.js ***!
  \*********************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__(/*! script-loader!tinycolor2 */ 811);
__webpack_require__(/*! ./../../external/modified/jquery.minicolors.js */ 813);
...
var AntaresBrandColors = {
    ...
    addStyles: function addStyles(indicator, elements, styles, value) {
        ...
        $('.cp-brand__ar-big').minicolors({
            ...
            change: function change(value, opacity) {
                ...
                if ($(this).closest('.cp-brand--primary').length) {
                    ...
                    //MAIN COLOR
                    var primaryTargets = ['.ddown.ddown--brand .ddown__menu li.is-selected .flex-block:after', 'aside.main-sidebar ul.main-menu .submenu.submenu--system section.section--2col .submenu__content .submenu__content-right .datarow .datarow__right i', '.flex-block .flex-block__badge', '.dropzone-form .dz-message .dz-m__content span', '.ddown .ddown__menu > li:hover > a', '.ddown .ddown__menu > li:hover > a i', 'i.zmdi-help-outline.help--trigger:hover',
                    //new
                    'aside.main-sidebar ul.main-menu .submenu.submenu--system section.section--2col .submenu__content .submenu__content-right .datarow .datarow__right i', '.main-menu .is-active .icon, .main-menu .is-active i, .main-menu .is-active .text', '.ddown.ddown--brand .ddown__menu li.is-selected .flex-block, .ddown.ddown--brand .ddown__menu li.is-selected .flex-block .flex-block__title', '#table-ma', '.timeline li.timeline__entry--ok:before', '.timeline li a', '.ddown.ddown--brand .ddown__menu li.is-selected .flex-block', '.ddown.ddown--brand .ddown__menu li.is-selected .flex-block .flex-block__title'],
                        primaryTargetsBackground = ['.app-content:before', '.switch .switch-checkbox:checked + .switch-container', '.app-content__footer .btn--submit', '.menu-aside-container', '.grid-col--menu, .menu-mobile-settings', '.app-content:before',
                    //new
                    '.mdl-textfield__label:after', '.card.card--chart-small .card__header', '.card.card--chart-small .card__header-chart', '.card.card--primary-light', '.btn.btn--primary'],
                        primaryTargetsBorder = ['.breadcrumbs .ddown__menu',
                    //new
                    ...
                    for (var k = 0; k < primaryTargetsBorder.length; k++) {
                        var newStyleBorderValue = 'transparent ' + value + ' transparent transparent;';
                    ...
                    //SECONDARY--------------------
                    var mr3 = tinycolor.mostReadable(value, ['#000'], {
                        includeFallbackColors: true,
                        level: 'AAA',
                        size: 'small'
                    }).toHexString();
                    ...
                    // BACKGROUND--------------------
                    var mr2 = tinycolor.mostReadable(value, ['#000'], {
                        includeFallbackColors: true,
                        level: 'AAA',
                        size: 'small'
                    }).toHexString();
            ...
            change: function change(value, opacity) {
                ...
                if ($(this).hasClass('cp-brand__p-sgl--left')) {
                    ...
                    if ($(this).closest('.cp-brand--secondary').length) {
                        ...
                        var secondaryRightTargets = ['aside.main-sidebar ul.main-menu > li > a:hover', 'aside.main-sidebar ul.main-menu > li > a:hover .icon', 'aside.main-sidebar ul.main-menu > li > a:hover i', 'aside.main-sidebar ul.main-menu > li.hovered .text', 'aside.main-sidebar ul.main-menu > li.hovered .icon', 'aside.main-sidebar ul.main-menu > li.hovered i', 'aside.main-sidebar ul.main-menu .submenu section .data-list li a:hover span'];
...
/***/ 811:
/*!***************************************************************************!*\
  !*** ./node_modules/script-loader!./node_modules/tinycolor2/tinycolor.js ***!
  \***************************************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! !./node_modules/script-loader/addScript.js */ 2)(__webpack_require__(/*! !./node_modules/raw-loader!./node_modules/tinycolor2/tinycolor.js */ 812))

/***/ }),

/***/ 812:
/*!************************************************************************!*\
  !*** ./node_modules/raw-loader!./node_modules/tinycolor2/tinycolor.js ***!
  \************************************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports) {
...
/***/ 813:
/*!********************************************************!*\
  !*** ./_src/js/external/modified/jquery.minicolors.js ***!
  \********************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 814:
/*!*****************************************************!*\
  !*** ./_src/js/components/brand_form/brand_form.js ***!
  \*****************************************************/
/*! no static exports found */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
