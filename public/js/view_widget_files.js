...
exports.antaresStore = undefined;
...
var filesWidget1 = {
    strict: true,
    state: _antares_mechanics.Antares.fileWidgetState,
    mutations: _antares_mechanics.Antares.fileWidgetMutations,
    actions: _antares_mechanics.Antares.fileWidgetActions
};

var tabsWidget1 = {
    strict: true,
    state: _antares_mechanics.Antares.tabsWidgetState,
    mutations: _antares_mechanics.Antares.tabsWidgetMutations,
    actions: _antares_mechanics.Antares.tabsWidgetActions
};

var antaresStore = exports.antaresStore = new _vuex2.default.Store({
    modules: {
...
var baseOrderBy = __webpack_require__(198),
...
var _antares_store = __webpack_require__(17);

_antares_mechanics.Antares.fileWidgetActions = {

        displayNotification: function displayNotification(context, notification) {
                context.commit('displayNotification', notification);
                setTimeout(function () {
                        context.commit('clearNotification');
                }, 4000);
        },
        clearNotification: function clearNotification(context) {
                context.commit('clearNotification');
        },
        setContentMenuItem: function setContentMenuItem(context, item) {
                var oneSelectedItem = context.state.areSelected.length === 1;
                if (oneSelectedItem) {
                        context.commit('clearSelected');
                }
                context.commit('selectItem', item);
                context.commit('setContentMenuItem', item);
        },

        refKeyChange: function refKeyChange(context, data) {
                context.commit('refKeyChange', data);
                // context.commit('clearSelected');
                // context.commit('addToSelected', antaresStore.state.filesWidget1.items[data]);
        },

        abortLoading: function abortLoading(context, data) {
                context.commit('abortLoading', data);
        },

        moveItem: function moveItem(context, data) {

                // first element of array = dragged Item Key (item[key])
                // second element of array = drag target Item Key (item[key])
                context.commit('moveItem', data);
        },

        orderCurrentSizeAsc: function orderCurrentSizeAsc(context) {
                context.commit('orderCurrentSizeAsc');
        },

        orderCurrentSizeDesc: function orderCurrentSizeDesc(context) {
                context.commit('orderCurrentSizeDesc');
        },

        orderCurrentDateAsc: function orderCurrentDateAsc(context) {
                context.commit('orderCurrentDateAsc');
        },

        orderCurrentDateDesc: function orderCurrentDateDesc(context) {
                context.commit('orderCurrentDateDesc');
        },

        orderCurrentNameAsc: function orderCurrentNameAsc(context) {
                context.commit('orderCurrentNameAsc');
        },

        orderCurrentNameDesc: function orderCurrentNameDesc(context) {
                context.commit('orderCurrentNameDesc');
        },

        // Order of Display - END

        /* Content detection actions */

        filesNotPresent: function filesNotPresent(context) {
                context.commit('filesNotPresent');
        },

        foldersNotPresent: function foldersNotPresent(context) {
                context.commit('foldersNotPresent');
        },

        filesPresent: function filesPresent(context) {
                context.commit('filesPresent');
        },

        foldersPresent: function foldersPresent(context) {
                context.commit('foldersPresent');
        },

        tutorialWasProvided: function tutorialWasProvided(context) {
                context.commit('tutorialWasProvided');
        },

        /* Content view actions */

        returnHome: function returnHome(context) {
                _antares_store.antaresStore.commit('returnHome');
        },

        loadDirectory: function loadDirectory(context, data) {
                // context.commit('preloadOn');
                context.commit('loadDirectory', data);

                // $.post('administrators/files/listing', data).then(function(response) {
                // antaresStore.dispatch('clearSelected');


                // return $.post('administrators/files/listing', data).then(function(response) {
                //     antaresStore.dispatch('clearSelected');

                //     context.commit('loadDirectory', response.content);
                //     context.commit('preloadOff');
                //     $('[data-scrollable]').scrollTop(0);
                // });
        ...
        clearSelected: function clearSelected(context) {
                context.commit('clearSelected');
        },

        addToSelected: function addToSelected(context, item) {
                // console.log(item);

                if (containsObject(item, _antares_store.antaresStore.state.filesWidget1.areSelected)) {
                        alert("juz kruwa jest chuj");
                }

                context.commit('addToSelected', item);
        }
...
_antares_mechanics.Antares.fileWidgetMutations = function () {
    'use strict';
    ...
    return {
        ...
        displayNotification: function displayNotification(state, data) {
            state.notification = data;
        },
        toggleSelectItem: function toggleSelectItem(state, item) {
            item.isSelected = !item.isSelected;
            var index = state.areSelected.indexOf(item);
            if (index === -1) {
                state.areSelected.push(item);
            } else {
                state.areSelected.splice(index, 1);
            }
        },
        ...
        unSelectItem: function unSelectItem(state, item) {
        ...
        setContentMenuItem: function setContentMenuItem(state, item) {
            state.xtcMenuItem = item;
        },

        refKeyChange: function refKeyChange(state, data) {
            state.ctxMenuRefkey = data;
            state.ctxMenuItemType = _antares_mechanics.Antares.store.state.filesWidget1.items[data].type;
        },
        abortLoading: function abortLoading(state, data) {

            state.items[data].isLoading = false;
        },
        preloadOn: function preloadOn(state) {
            state.preloading = true;
        },

        preloadOff: function preloadOff(state) {
            state.preloading = false;
        },
        tutorialWasProvided: function tutorialWasProvided(state) {
            state.tutorialProvided = true;
        },
        loadDirectory: function loadDirectory(state, data) {
            console.log(data);
            state.currentView = data.items;
            state.areSelected = [];
            // state.currentPath = data.paths.reverse();
            // state.insideFolder = data.paths.length !== 0;
            _antares_store.antaresStore.commit('preloadOn');
        },
        moveItem: function moveItem(state, data) {
            console.log('moving items!');
            console.log(data);
        },
        goBack: function goBack(state) {
            state.currentPath.pop();
            var newDirectory = state.currentPath.pop();
            newDirectory = newDirectory ? newDirectory.path : '';
            _antares_mechanics.Antares.store.dispatch('loadDirectory', { 'directory': newDirectory });
        },

        returnHome: function returnHome(state) {
            state.currentView = state.widgetData.Default;
        },
        removeItem: function removeItem(state, data) {
            state.items.splice(data, 1);
        },

        orderCurrentSizeAsc: function orderCurrentSizeAsc(state) {
            var _ = __webpack_require__(30);
            state.items = _.orderBy(state.items, ['size.raw'], ['asc']);
        },

        orderCurrentSizeDesc: function orderCurrentSizeDesc(state) {
            var _ = __webpack_require__(30);
            state.items = _.orderBy(state.items, ['size.raw'], ['desc']);
        },

        orderCurrentDateAsc: function orderCurrentDateAsc(state) {
            var _ = __webpack_require__(30);
            state.items = _.orderBy(state.items, ['timestamp.raw'], ['asc']);
        },

        orderCurrentDateDesc: function orderCurrentDateDesc(state) {
            var _ = __webpack_require__(30);
            state.items = _.orderBy(state.items, ['timestamp.raw'], ['desc']);
        },

        orderCurrentNameAsc: function orderCurrentNameAsc(state) {
            var _ = __webpack_require__(30);
            state.items = _.orderBy(state.items, ['name'], ['asc']);
        },

        orderCurrentNameDesc: function orderCurrentNameDesc(state) {
            var _ = __webpack_require__(30);
            state.items = _.orderBy(state.items, ['name'], ['desc']);
        },

        filesPresent: function filesPresent(state) {
            state.filesPresent = true;
        },

        filesNotPresent: function filesNotPresent(state) {
            state.filesPresent = false;
        },

        foldersPresent: function foldersPresent(state) {
            state.foldersPresent = true;
        },

        foldersNotPresent: function foldersNotPresent(state) {
            state.foldersPresent = false;
        },

        searchQueryUpdate: function searchQueryUpdate(state, data) {
            state.searchQuery = data;
        },

        hideSearchInput: function hideSearchInput(state) {
            state.searchActive = false;
            state.searchQuery = '';
        },

        showSearchInput: function showSearchInput(state) {
            state.searchActive = true;
        },

        pathScrollable: function pathScrollable(state, data) {
            state.pathScrollable = true;
        },

        pathNotScrollable: function pathNotScrollable(state, data) {
            state.pathScrollable = false;
        },

        removeFromSelected: function removeFromSelected(state, item) {},

        addToSelected: function addToSelected(state, item) {

            // areSelected
            var selectedIndex = state.areSelected.indexOf(item);
            var itemIndex = state.items.indexOf(item);

            if (!containsObject(item, _antares_mechanics.Antares.store.state.filesWidget1.areSelected)) {
                state.areSelected.push(item);
                state.items[itemIndex].isSelected = true;
            } else {
                state.areSelected.splice(selectedIndex, 1);
                state.items[itemIndex].isSelected = false;
            }
        ...
        clearSelected: function clearSelected(state) {
            ...
            for (var i = 0, l = state.items.length; i < l; ++i) {
                state.items[i].isSelected = false;
            }
        },

        mainDropdownToggle: function mainDropdownToggle(state) {
            state.mainDropdown = !state.mainDropdown;
            state.bottomDropdown = false;
        },

        bottomDropdownToggle: function bottomDropdownToggle(state) {
            state.bottomDropdown = !state.bottomDropdown;
            state.mainDropdown = false;
        },

        selectAllItems: function selectAllItems(state) {
            for (var i = 0, l = state.items.length; i < l; ++i) {
                state.items[i].isSelected = true;
                _antares_mechanics.Antares.store.commit('addToSelected', state.items[i]);
            }
        },

        toggleAnimation: function toggleAnimation(state) {
            state.animating = !state.animating;
        },

        toggleItemMenuEvent: function toggleItemMenuEvent(state, index) {
            for (var i = 0, l = state.items.length; i < l; ++i) {
                state.widgetData[i].isDropdownActive = false;
            }

            state.mainDropdown = false;
            state.bottomDropdown = false;
            state.widgetData[index].isDropdownActive = !state.items[index].isDropdownActive;
        },

        itemMenuOff: function itemMenuOff(state) {
            state.bottomDropdown = false;
            state.mainDropdown = false;
            for (var i = 0, l = state.items.length; i < l; ++i) {
                state.items[i].isDropdownActive = false;
            }
        }
...
_antares_mechanics.Antares.fileWidgetState = {
    widgetBigMode: false,
    activeFilter: null,
    notification: null,
    notificationTimeout: 10000,
    widgetName: 'Files Manager',
    maximizable: true,
    searchable: true,
    dropdownable: true,
    areSelected: [],
    ...
    animating: false,
    // preloading: false,
    dndNewContnentDetected: false,
    tutorialProvided: false,
    ctxMenuRefkey: 0,
    ctxMenuItemType: '',
    ...
    widgetData: {
        Default: [{
            type: 'folder',
            icon: 'zmdi-folder',
            iconColor: 'avatar--green',
            name: 'Personal',
            timestamp: { raw: window.randomDate(), friendly: window.randomDate() },
            additional: 'Lorem parsum lorem murdum furdum, bolec stolec tramp. Lorem parsum lorem murdum furdum, bolec stolec tramp.',
            size: { raw: window.generateRandomNumber(), friendly: window.generateRandomNumber() },
            hasMenu: true,
            isSelected: false,
            ...
            type: 'file',
            icon: 'zmdi-file',
            iconColor: 'avatar--grey avatar--xls',
            name: 'YAntares Framework',
            timestamp: { raw: window.randomDate(), friendly: window.randomDate() },
            size: { raw: window.generateRandomNumber(), friendly: window.generateRandomNumber() },
            hasMenu: true,
            isSelected: false,
            ...
            type: 'file',
            icon: 'zmdi-file',
            iconColor: 'avatar--grey avatar--pdf',
            name: 'NAntares Framework',
            timestamp: { raw: window.randomDate(), friendly: window.randomDate() },
            size: { raw: window.generateRandomNumber(), friendly: window.generateRandomNumber() },
            hasMenu: true,
            isSelected: false,
            ...
            type: 'file',
            icon: 'zmdi-file',
            iconColor: 'avatar--grey avatar--doc',
            name: 'CAntares Framework',
            timestamp: { raw: window.randomDate(), friendly: window.randomDate() },
            additional: 'Lorem parsum lorem murdum furdum, bolec stolec tramp. Lorem parsum lorem murdum furdum, bolec stolec tramp.',
            size: { raw: window.generateRandomNumber(), friendly: window.generateRandomNumber() },
            hasMenu: true,
...
_antares_mechanics.Antares.tabsWidgetActions = {

    widgetRemove: function widgetRemove(context, data) {}
...
_antares_mechanics.Antares.tabsWidgetMutations = {

    convertToTabs: function convertToTabs(state, id) {
        state.widgetList[id].type = "tabs";
        noty($.extend({}, APP.noti.infoFM("lg", "full"), { text: "Widget has been converted to widget-tabs." }));
    },

    convertTab: function convertTab(state, data) {

        // console.log(data);
        // noty($.extend( {}, APP.noti.infoFM("lg", "full"), {text: "Widget has been converted to " + data.type + "."}));
        state.widgetList[data.currentId].type = data.lastTab.type;
        // alert('tab converted')
    },

    // Moving Cards
    draggedElem: function draggedElem(state, data) {
        state.draggedElem = data;
    },

    draggedOnElem: function draggedOnElem(state, data) {
        state.draggedOnElem = data;
    },

    draggedElemGsi: function draggedElemGsi(state, data) {
        state.draggedElemGsi = data;
    },

    draggedOnElemGsi: function draggedOnElemGsi(state, data) {
        state.draggedOnElemGsi = data;
    },

    draggedOnType: function draggedOnType(state, id) {
        state.draggedOnType = state.widgetList[id].type;
    },

    // Moving Tabs
    draggedTabElem: function draggedTabElem(state, data) {
        state.draggedTabElem = data;
    },

    draggedOnTabElem: function draggedOnTabElem(state, data) {
        state.draggedOnTabElem = data;
    },

    oneTabLeft: function oneTabLeft(state, data) {

        var currentType = $('.grid-stack-item[data-id="' + data.id + '"]').find(".mdl-tabs__panel > .card").attr("data-widget-name");

        for (var i = 0; i < state.widgetList.length; i++) {
            if (state.availableWidgets[i].id == data.id) {
                state.availableWidgets[i].type = currentType;
            }
        }
    },

    widgetRemove: function widgetRemove(state, idToRemove) {

        // simple remove
        // console.log($('.grid-stack-item[data-id="'+idToRemove+'"]').find('.card'))
        var grid = $('.grid-stack').data('gridstack');
        grid.removeWidget($('.grid-stack-item[data-id="' + idToRemove + '"]'));

        setTimeout(function () {
            _antares_mechanics.Antares.tabsWidgetMutations.rebulidGridstack();
        }, 100);
    },

    rebulidGridstack: function rebulidGridstack() {
        var grid = $('.grid-stack').data('gridstack');
    ...
    setWigetIDs: function setWigetIDs(state) {

        var index = 0;

        for (var i = 0; i < state.widgetList.length; i++) {
            state.availableWidgets[i].id = index;
            index++;
        }
    },

    addNewWidget: function addNewWidget(state, widgetType) {

        console.log(widgetType);

        // cache
        var _id, _title, _widgetName, _width, _height, _y, _x, _minWidth, _minHeight, _noResize, _noMove, _tabbable, _classList;

        var detachedWidgetIndex = _.findIndex(state.availableWidgets, function (o) {
            return o.type === widgetType;
        });

        console.log(detachedWidgetIndex);

        var givenTab = state.availableWidgets[detachedWidgetIndex];
        ...
        // setTimeout(function() {
        //     Antares.tabsWidgetMutations.rebulidGridstack();
        // },700);
    }
...
var widgetList = [{
    ...
    noMove: 1,
    tabbable: true,
    classList: 'card--news card--primary'
}, {
    id: 0,
    title: 'Logs',
    widgetName: 'logs',
...
//     noMove: 1,
//     tabbable: true,
//     classList: 'card--tabs card--tabs-combined',
// }, {
//     id: 0,
//     title: 'Tabs',
//     type:'tabs',
...
_antares_mechanics.Antares.tabsWidgetState = {

    draggedElem: null,
    draggedOnElem: null,
    draggedElemGsi: null,
    draggedOnElemGsi: null,
    draggedTabElem: null,
    draggedOnTabElem: null,
    draggedOnType: null,
    myArray: [],
    editMode: true,
    autoPosition: true,
    preloader: false,
    removeTabButton: false,
    processing: false,
    noty: {
        processingText: 'Processing... Hold Your Horses...',
        mergedText: 'Widgets merged.',
        newTabsWidgetText: 'New tabs widget created.',
        newTabText: 'New Tab has been added.',
        alreadyTabbedText: 'Cant merge tabbed widget.',
        newWidgetInGridText: 'New widget added to grid'
    },
    transitionName: 'fadeOut',
    widgetList: widgetList,
    availableWidgets: widgetList
...
var compareAscending = __webpack_require__(205);
...
// import '' './../../../js/components/widget_files/widgetFiles.vue'
...
var _widget_files = __webpack_require__(708);

var _widget_files2 = _interopRequireDefault(_widget_files);
...
(function (window) {
    ...
    var filesParent = new _vue2.default({

        name: 'widget_files_wrapper',
        el: '.main-content',
        components: {
            'widget-files': _widget_files2.default
        }
    });
}).call(undefined);
...
var _vueClickaway = __webpack_require__(703);
...
// import Vue from 'vue';
var fileupload = __webpack_require__(394);
window.fileupload = fileupload;
var contextMenu = __webpack_require__(704);
window.contextMenu = contextMenu;
// var clickaway = require('vue-clickaway');
// import { Antares } from './../../mechanics';

var dotdotdot = __webpack_require__(607);

var selectedMenuArchitect = {
    name: 'selected-menu',
    template: '#widget-files-selected-menu',
    data: function data() {
        return {};
    },
    computed: {
        mainDropdown: function mainDropdown() {
            return _antares_store.antaresStore.state.filesWidget1.mainDropdown;
        },
        bottomDropdown: function bottomDropdown() {
            return _antares_store.antaresStore.state.filesWidget1.bottomDropdown;
        },
        items: function items() {
            return _antares_store.antaresStore.state.filesWidget1.items;
        },
        areSelected: function areSelected() {
            return _antares_store.antaresStore.state.filesWidget1.areSelected;
        }
    },
    methods: {
        selectAllItems: function selectAllItems() {
            _antares_store.antaresStore.dispatch('selectAllItems');
        },
        downloadFile: function downloadFile() {
            this.uxPreloader(this.uxTransition);
            alert('files ready to download');
        },
        bottomDropdownToggle: function bottomDropdownToggle() {
            _antares_store.antaresStore.dispatch('bottomDropdownToggle');
        },
            ...
            $('.sweet-confirm').on('click', function () {
                ...
                self.$nextTick(function () {
                    for (var i = 0; i < self.items.length; i++) {
                        if (self.items[i].isSelected == true) {
                            var index = self.items.indexOf(self.items[i]);
                            _antares_store.antaresStore.dispatch('removeItem', index);
                        }
                    }
                    $this.off('click');
                });
...
var mainMenuArchitect = {
    name: 'main-menu',
    template: '#widget-files-main-menu',
    data: function data() {
        return {
            activeSorting: 34
        };
    ...
    methods: {
        inputFile: function inputFile() {
            $(this.$refs.fileUpload).closest('.card--files').find('input[type="file"]').trigger('click');
        },
        sortChangeActive: function sortChangeActive(event) {
            var activeClass = 'is-active';
            console.log($(event.target));
            var $target = $(event.target).closest('li');
            $target.closest('ul').find('li').removeClass(activeClass);
            $target.addClass(activeClass);
        },
        sortSizeAsc: function sortSizeAsc() {
            _antares_store.antaresStore.dispatch('orderCurrentSizeAsc');
            _antares_store.antaresStore.dispatch('mainDropdownToggle');
            this.activeSorting = 'sizeAsc';
        },
        sortSizeDesc: function sortSizeDesc() {
            _antares_store.antaresStore.dispatch('orderCurrentSizeDesc');
            _antares_store.antaresStore.dispatch('mainDropdownToggle');
            this.activeSorting = 'sizeDesc';
        },
        sortDateAsc: function sortDateAsc() {
            _antares_store.antaresStore.dispatch('orderCurrentDateAsc');
            _antares_store.antaresStore.dispatch('mainDropdownToggle');
            this.activeSorting = 'dateAsc';
        },
        sortDateDesc: function sortDateDesc() {
            _antares_store.antaresStore.dispatch('orderCurrentDateDesc');
            _antares_store.antaresStore.dispatch('mainDropdownToggle');
            this.activeSorting = 'dateDesc';
        },
        sortNameAsc: function sortNameAsc() {
            _antares_store.antaresStore.dispatch('orderCurrentNameAsc');
            _antares_store.antaresStore.dispatch('mainDropdownToggle');
            this.activeSorting = 'nameAsc';
        },
        sortNameDesc: function sortNameDesc() {
            _antares_store.antaresStore.dispatch('orderCurrentNameDesc');
            _antares_store.antaresStore.dispatch('mainDropdownToggle');
            this.activeSorting = 'nameDesc';
        },
        mainDropdownToggle: function mainDropdownToggle() {
            _antares_store.antaresStore.dispatch('mainDropdownToggle');
        },
        selectAllItems: function selectAllItems() {
            _antares_store.antaresStore.dispatch('selectAllItems');
...
var notificationArchitect = {
    name: 'notification-area',
    template: '#widget-files-notification-area',
    data: function data() {
        return {};
    },
    computed: {
        notification: function notification() {
            return _antares_store.antaresStore.state.filesWidget1.notification;
        },
        has: function has() {
        ...
        color: function color() {
            return this.isSuccess ? '#28BE00' : '#e43e3e';
        }
    }
};
...
exports.default = {
    ...
    components: {
        'selected-menu': selectedMenuArchitect,
        'main-menu': mainMenuArchitect,
        'context-menu': contextMenu,
        'notification-area': notificationArchitect
    },
    template: '#widget-files-template',
    data: function data() {
        return {
            searchQuery: '',
            fileDetected: false,
    ...
    computed: (_computed = {
        currentView: function currentView() {
            return _antares_store.antaresStore.state.filesWidget1.currentView;
        },
        widgetData: function widgetData() {
            return _antares_store.antaresStore.state.filesWidget1.widgetData;
        },
        notification: function notification() {
            return _antares_store.antaresStore.state.filesWidget1.notification;
        },
        clipboardHasItems: function clipboardHasItems() {
            return _antares_store.antaresStore.state.filesWidget1.clipboardHasItems;
        },
        dndNewContnentDetected: function dndNewContnentDetected() {
            return _antares_store.antaresStore.state.filesWidget1.dndNewContnentDetected;
        },
        preloading: function preloading() {
            return _antares_store.antaresStore.state.filesWidget1.preloading;
        },
        animating: function animating() {
            return _antares_store.antaresStore.state.filesWidget1.animating;
        },
        bottomDropdown: function bottomDropdown() {
            return _antares_store.antaresStore.state.filesWidget1.bottomDropdown;
        },
        ...
        foldersPresent: function foldersPresent() {
            return _antares_store.antaresStore.state.filesWidget1.foldersPresent;
        },
        filesPresent: function filesPresent() {
            return _antares_store.antaresStore.state.filesWidget1.filesPresent;
        },
        items: function items() {
            return _antares_store.antaresStore.state.filesWidget1.items;
        },
        widgetName: function widgetName() {
            return _antares_store.antaresStore.state.filesWidget1.wdigetName;
        },
        maximizable: function maximizable() {
            return _antares_store.antaresStore.state.filesWidget1.maximizable;
        },
        searchable: function searchable() {
            return _antares_store.antaresStore.state.filesWidget1.searchable;
        },
        dropdownable: function dropdownable() {
            return _antares_store.antaresStore.state.filesWidget1.dropdownable;
        }
    }, _defineProperty(_computed, 'maximizable', function maximizable() {
        return _antares_store.antaresStore.state.filesWidget1.maximizable;
    }), _defineProperty(_computed, 'areSelected', function areSelected() {
        return _antares_store.antaresStore.state.filesWidget1.areSelected;
    }), _defineProperty(_computed, 'insideFolder', function insideFolder() {
        return _antares_store.antaresStore.state.filesWidget1.insideFolder;
    }), _defineProperty(_computed, 'currentPath', function currentPath() {
        return _antares_store.antaresStore.state.filesWidget1.currentPath;
    }), _defineProperty(_computed, 'pathScrollable', function pathScrollable() {
        return _antares_store.antaresStore.state.filesWidget1.pathScrollable;
    }), _defineProperty(_computed, 'searchActive', function searchActive() {
        return _antares_store.antaresStore.state.filesWidget1.searchActive;
    }), _defineProperty(_computed, 'tutorialProvided', function tutorialProvided() {
        return _antares_store.antaresStore.state.filesWidget1.tutorialProvided;
    }), _defineProperty(_computed, 'ctxMenuRefkey', function ctxMenuRefkey() {
        return _antares_store.antaresStore.state.filesWidget1.ctxMenuRefkey;
    }), _defineProperty(_computed, 'ctxMenuItemType', function ctxMenuItemType() {
        return _antares_store.antaresStore.state.filesWidget1.ctxMenuItemType;
    }), _defineProperty(_computed, 'searchFilter', function searchFilter(item, key, index) {
        _antares_store.antaresStore.dispatch('filesNotPresent');
        _antares_store.antaresStore.dispatch('foldersNotPresent');
        var widget = _antares_store.antaresStore.state.filesWidget1;
        console.log(widget);
        var items = widget.currentView;

        if (items.length > 0) {

            for (var i = 0, l = items.length; i < l; ++i) {
                if (items[i].type === 'folder' && this.foldersPresent === false) {
                    _antares_store.antaresStore.dispatch('foldersPresent');
                } else if (items[i].type === 'file' && this.filesPresent === false) {
                    _antares_store.antaresStore.dispatch('filesPresent');
                }
            }
            var searchQuery = widget.searchQuery.toLowerCase();
            return items.filter(function (displayItem) {
                var itemName = displayItem.name.toLowerCase(),
                    itemSize = displayItem.size.friendly.toLowerCase(),
                    itemTimestamp = displayItem.timestamp.friendly.toLowerCase();
                return itemName.indexOf(searchQuery) !== -1 || itemSize.indexOf(searchQuery) !== -1 || itemTimestamp.indexOf(searchQuery) !== -1;
            });
        }
    }), _computed),
    mounted: function mounted() {
        var self = this;
        this.updateMdl();
        // antaresStore.dispatch('loadDirectory', {
        //     'directory': ''
        // });
        this.jqueryFileUpload();
        this.listDND();
        this.uxPreloader(this.uxTransition);
        this.selectableRect();
        ...
        _antares_store.antaresStore.dispatch('returnHome');
    },
    methods: {
        onResize: function onResize() {},

        listDNDEnable: function listDNDEnable() {
            $(self.$el).find('.flex-block--file').draggable({
                disabled: false,
                delay: 1000
            });
        },
        listDNDDisable: function listDNDDisable() {
            $(self.$el).find('.flex-block--file').draggable({
                disabled: true,
                delay: 1000
            });
        },
        listDND: function listDND() {
            var $this = $(this.$el),
                self = this;
            $this.find('.flex-block--file').draggable({
                scope: "fw",
                helper: "clone"
            });
            $this.find('.flex-block--file.type-folder').droppable({
                greedy: true,
                scope: "fw",
                over: function over(event, ui) {
                    $('.is-dragged-over').removeClass('is-dragged-over');
                    $(this).addClass('is-dragged-over');
                ...
                drop: function drop(event, ui) {
                    var dragMovedItemKey = $(ui.draggable[0]).attr('data-key'),
                        dragMovedItem = self.items[dragMovedItemKey];
                    event.stopPropagation();
                    event.preventDefault();
                    APP.swal.init('skin2', 'typeInfo', {
                        title: 'Do You want to move item(s)?',
                        text: "Can't undo this operation."
                    });
                    $('.sweet-confirm').on('click', function () {
                        var $this = $(this),
                            dragTargetItemKey = $(event.target).attr('data-key'),
                            dragTargetItem = self.items[dragTargetItemKey];
                        if (_antares_store.antaresStore.state.filesWidget1.areSelected.length) {
                            self.$nextTick(function () {
                                for (var i = 0, l = self.items.length; i < l; ++i) {
                                    // TODO: show items info in modal
                                }
                            });
                        } else {
                            var itemsToMove = [];
                            itemsToMove.push({
                                fromPath: dragMovedItem.path,
                                toPath: dragTargetItem.path
                            });
                            _antares_store.antaresStore.dispatch('moveItems', itemsToMove);
                        }
                        $this.off('click');
                    });
                }
        ...
        fileDND: function fileDND() {
            self = this;
            // var $form = $('.card--files');
            var $files = $('.card--files');
            Antares.droppedFiles = false;
            $files.on('drag dragstart dragend dragover dragenter dragleave drop', function (e) {
                ...
                $files.addClass('is-dragover');
            }).on('dragleave dragend drop', function (e) {
                $files.removeClass('is-dragover');
            }).on('drop', function (e) {
                Antares.droppedFiles = e.originalEvent.dataTransfer.files;
                // console.log(Antares.droppedFiles);
            });
        },
        wfDialogRename: function wfDialogRename() {
            var $dialog = $('dialog[data-dialog-id="wf-rename"]'),
                dialog = $dialog[0];
            dialogPolyfill.registerDialog(dialog);
            dialog.showModal();
            // Cancel
            ...
            // Accept
            $dialog.on('click', '.accept', function () {
                var value = $dialog.find('.wf-input').val();
                if (value !== '' && value !== undefined) {
                    console.log(value); // Zrob cos ze mna
                    $(this).closest('dialog')[0].close();
                    $dialog.off('click', '.accept');
                }
            });
        },
        wfDialogNewDir: function wfDialogNewDir() {
            var $dialog = $('dialog[data-dialog-id="wf-newDir"]'),
                dialog = $dialog[0];
            dialogPolyfill.registerDialog(dialog);
            dialog.showModal();
            // Cancel
        ...
        simulateNotification: function simulateNotification() {
            setTimeout(function () {
                var notification = {
                    message: 'Now THATS a notification text, woah!',
                    success: true
                };
                _antares_store.antaresStore.dispatch('displayNotification', notification);
            }, 3500);
        },
        selectableRect: function selectableRect() {
            var self = this;
            // $('.card--files .card__content').selectable({
            //     filter: ".flex-block--file",
            //     selecting: function(event, ui) {
            //         $(ui.selecting).addClass('is-selected');
            //     },
            //     selected: function(event, ui) {
            //         $(ui.selected).addClass('is-selected');
            //     },
            //     unselected: function(event, ui) {
            //         $(ui.unselected).removeClass('is-selected');
            //     },
            //     unselecting: function(event, ui) {
            //         $(ui.unselecting).removeClass('is-selected');
            //     },
            // });
        },
        newDirectory: function newDirectory() {},
        pasteSelectedItems: function pasteSelectedItems() {},
        outsideClick: function outsideClick() {
            this.itemMenuOff();
        },
        openItem: function openItem(item) {},
        copyItem: function copyItem(item) {},
        cutItem: function cutItem(item) {},
        pasteItem: function pasteItem(item) {},
        fireCtxMenuFolders: function fireCtxMenuFolders(event, item) {
            this.$refs.ctxMenuFiles.ctxVisible = false;
            this.$refs.ctxMenuSpace.ctxVisible = false;
            this.$refs.ctxMenuFolders.open(event);
            _antares_store.antaresStore.dispatch('setContentMenuItem', item);
        },
        fireCtxMenuFiles: function fireCtxMenuFiles(event, item) {
            this.$refs.ctxMenuFolders.ctxVisible = false;
            this.$refs.ctxMenuSpace.ctxVisible = false;
            this.$refs.ctxMenuFiles.open(event);
            _antares_store.antaresStore.dispatch('setContentMenuItem', item);
        },
        fireCtxMenuSpace: function fireCtxMenuSpace(event) {
            var isItemContainer = $(event.target).closest('.item-container').length;
            if (!isItemContainer) {
                this.$refs.ctxMenuFolders.ctxVisible = false;
                this.$refs.ctxMenuFiles.ctxVisible = false;
                this.$refs.ctxMenuSpace.open(event);
            }
        },
        ctxm_selectItem: function ctxm_selectItem(event) {
            // console.log(event);
        },
        attention: function attention() {
            alert('ATTENTION!!!');
        },
        abortLoading: function abortLoading(key) {
            _antares_store.antaresStore.dispatch('abortLoading', key);
        },
        tutorial: function tutorial() {
            var timeoutId;
            if (this.tutorialProvided === false) {
                $(this.$el).hover(function () {
                    if (!timeoutId) {
                        timeoutId = setTimeout(function () {
                            noty($.extend({}, APP.noti.infoFM("lg", "full"), {
                                text: "Use double mouse click, to navigate!"
                            }));
                            _antares_store.antaresStore.dispatch('tutorialWasProvided');
                        }, 6000);
                    }
                }, function () {
                    if (timeoutId) {
        ...
        uxPreloader: function uxPreloader(time) {
            // antaresStore.dispatch('preloadOn');
            // setTimeout(function() {
            //     antaresStore.dispatch('preloadOff');
            // }, time);
        },
        itemMenuOff: function itemMenuOff(event) {
            _antares_store.antaresStore.dispatch('itemMenuOff');
        },
        jqueryFileUpload: function jqueryFileUpload() {
            $('.files-upload-input').fileupload();
            var $files = $('.card--files');
            $files.on('dragover dragenter', function (e) {
                $files.addClass('is-dragover');
                e.stopPropagation();
            }).on('dragleave dragend drop', function (e) {
                $files.removeClass('is-dragover');
        ...
        createMdl: function createMdl(item, key) {},
        ...
        toggleItemMenu: function toggleItemMenu(item, event) {
            event.preventDefault();
            event.stopPropagation();
            var index = _antares_store.antaresStore.state.filesWidget1.currentView.indexOf(item);
            _antares_store.antaresStore.dispatch('toggleItemMenuEvent', index);
        },
        cleanup: function cleanup() {
            $('.files-ddown.is-visible').removeClass('is-visible');
        },
        inputFile: function inputFile() {
            $(this.$refs.fileUpload).find('input[type="file"]').trigger('click');
        },
        updateStore: function updateStore(data) {
            _antares_store.antaresStore.dispatch('searchQueryUpdate', this.searchQuery);
            this.uxPreloader(500);
        },
        displaySearch: function displaySearch() {
            _antares_store.antaresStore.dispatch('showSearchInput');
            var self = this;
            this.$nextTick(function () {
                self.updateMdl();
                $(this.$el).find('#files-widget-search').focus();
            });
        },
        hideSearch: function hideSearch() {
            this.uxPreloader(500);
            _antares_store.antaresStore.dispatch('hideSearchInput');
            var self = this;
            this.$nextTick(function () {
                self.updateMdl();
            });
        },
        pathScroll: function pathScroll() {
            var $path = $('.card__path-inner');
            setTimeout(function () {
                $path.scrollLeft('9999');
            }, 10);
            this.$nextTick(function () {
                var action = $path.hasScrollBar() ? 'pathScrollable' : 'pathNotScrollable';
                _antares_store.antaresStore.dispatch(action);
            });
        },
        pathChange: function pathChange(data) {
            _antares_store.antaresStore.dispatch('loadDirectory', data);
        },
        enterFolder: function enterFolder(data) {
            ...
            if (data.type === 'folder') {
                _antares_store.antaresStore.dispatch('clearSelected');
                _antares_store.antaresStore.dispatch('loadDirectory', data);
        ...
        goBack: function goBack() {
            this.uxPreloader(this.uxTransition);
            _antares_store.antaresStore.dispatch('clearSelected');
            _antares_store.antaresStore.dispatch('goBack');
            this.pathScroll();
            this.$nextTick(function () {
                self.updateMdl();
            });
        ...
        selectItem: function selectItem(item, key) {
            ...
            // this.$refs.ctxMenuFolders.ctxVisible = false;
            // item.isSelected = !item.isSelected;
            _antares_store.antaresStore.dispatch('addToSelected', item);
        }
    }
};
...
( function( factory ) {
	if ( true ) {
		...
		// AMD. Register as an anonymous module.
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(16), __webpack_require__(614) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else {
...
Component.options.__file = "C:\\Projekty\\front\\_src\\js\\components\\widget_files\\widget_files.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] widget_files.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-92748874", Component.options)
  } else {
    hotAPI.reload("data-v-92748874", Component.options)
  }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "card card--files",
    class: {
      'is-preloading': _vm.preloading
    }
  }, [_c('main-menu'), _vm._v(" "), _c('input', {
    staticClass: "files-upload-input",
    attrs: {
      "type": "file"
    }
  }), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("Files Widget")]) : _vm._e(), _vm._v(" "), _c('div', {
    ...
    staticClass: "search-box__mdl-textfield mdl-textfield mdl-js-textfield"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    staticClass: "mdl-textfield__input search-box__search-field",
    attrs: {
      "type": "text",
      "id": "files-widget-search"
    },
    domProps: {
      "value": (_vm.searchQuery)
    },
    ...
    attrs: {
      "for": "#files-widget-search"
    }
  }, [_vm._v("Search...")])])])]) : _vm._e(), _vm._v(" "), ((_vm.searchable, !_vm.searchActive)) ? _c('div', {
    staticClass: "btn-more mdl-js-button mdl-js-ripple-effect",
    on: {
      "click": _vm.displaySearch
    }
  }, [_c('i', {
    staticClass: "zmdi zmdi-search",
    attrs: {
      "data-tooltip-inline": "Search Widget"
    }
  })]) : _vm._e(), _vm._v(" "), (_vm.searchActive) ? _c('div', {
    staticClass: "btn-more mdl-js-button mdl-js-ripple-effect",
    on: {
    ...
    attrs: {
      "data-tooltip-inline": "Close Search"
    }
  })]) : _vm._e(), _vm._v(" "), (_vm.maximizable) ? _c('div', {
    staticClass: "card-maximize btn-more mdl-js-button mdl-js-ripple-effect"
  }, [_c('i', {
    staticClass: "zmdi zmdi-window-maximize",
    attrs: {
      "data-tooltip-inline": "Maximize Widget"
    }
  })]) : _vm._e(), _vm._v(" "), (_vm.dropdownable) ? _c('div', {
    staticClass: "btn-more mdl-js-button mdl-js-ripple-effect",
    class: {
      'dropdown-active': _vm.mainDropdown
    },
    on: {
      "click": _vm.mainDropdownToggle
    }
  }, [_c('i', {
    staticClass: "zmdi zmdi-more-vert",
    attrs: {
      "data-tooltip-inline": "DDown Widget"
    }
  })]) : _vm._e()])]), _vm._v(" "), _c('div', {
    staticClass: "card__content",
    class: {
      'items-selected': _vm.areSelected.length > 0, 'file-detected': _vm.fileDetected
    }
  }, [(_vm.preloading) ? _c('div', [_c('div', {
    staticClass: "spinner-xs"
  })]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "current-view",
    class: {
      'ripple': _vm.animating
    },
    attrs: {
      "data-scrollable": ""
    },
    on: {
      ...
      "contextmenu": function($event) {
        $event.preventDefault();
        _vm.fireCtxMenuSpace($event)
      }
    }
  }, [(_vm.insideFolder) ? _c('div', {
    staticClass: "card__path",
    class: {
      'is-scrollable': _vm.pathScrollable
    }
  }, [_c('div', {
    staticClass: "btn-back mdl-js-button mdl-js-ripple-effect",
    on: {
      "click": _vm.goBack
    }
  }, [_c('i', {
    staticClass: "zmdi zmdi-arrow-left"
  })]), _vm._v(" "), _c('div', {
    staticClass: "card__path-inner"
  }, [_c('transition-group', {
    attrs: {
      "name": "fade-bread",
      "tag": "p"
    }
  }, _vm._l((_vm.currentPath), function(element) {
    return _c('span', {
      key: element,
      staticClass: "single",
      on: {
        "click": function($event) {
          _vm.pathChange(element)
        }
      }
  ...
  }, [((_vm.searchQuery.length > 0 && _vm.searchFilter.length === 0)) ? _c('div', {
    staticClass: "files__zero-data files__zero-data--search"
  }, [_c('i', {
    staticClass: "zmdi zmdi-search-in-file"
  }), _vm._v(" "), _c('p', [_vm._v("No Files Found.")])]) : _vm._e()]), _vm._v(" "), _c('transition', {
    attrs: {
      "name": "fade-zd"
    }
  }, [(_vm.currentView.length === 0) ? _c('div', {
    staticClass: "files__zero-data files__zero-data--content"
  }, [_c('i', {
    staticClass: "zmdi zmdi-search-in-file"
  }), _vm._v(" "), _c('p', [_vm._v("No Files Found.")]), _vm._v(" "), _c('p', {
    staticClass: "dnd-info"
  }, [_vm._v("Drag and drop files to upload, or "), _c('a', {
    attrs: {
      "href": ""
    }
  }, [_vm._v("click here")]), _vm._v(".")])]) : _vm._e()]), _vm._v(" "), _vm._m(0), _vm._v(" "), _vm._m(1), _vm._v(" "), _c('div', {
    staticClass: "files-section"
  }, [((_vm.foldersPresent && _vm.searchFilter.length > 0)) ? _c('p', {
    staticClass: "files-label"
  }, [_vm._v("FOLDERS:")]) : _vm._e(), _vm._v(" "), _c('transition-group', {
    staticClass: "item-container",
    attrs: {
      "name": "fade",
      "tag": "p"
    }
  }, _vm._l((_vm.searchFilter), function(item, key) {
    return (item.type === 'folder') ? _c('div', {
      key: item,
      staticClass: "flex-block flex-block--bold flex-block--file",
      class: {
        'is-selected': item.isSelected, 'type-folder': item.type === 'folder', 'type-file': item.type === 'file', 'is-loading': item.isLoading
      },
      attrs: {
        "data-key": key,
        "data-selected": _vm.areSelected.length > -1 ? _vm.areSelected.length : 1
      },
      on: {
        "click": [function($event) {
          $event.preventDefault();
          if (!$event.ctrlKey) { return null; }
          _vm.selectItem(item, key)
        }, _vm.itemMenuOff],
        ...
        "contextmenu": function($event) {
          $event.preventDefault();
          _vm.fireCtxMenuFolders($event, item)
        }
      }
    }, [_c('context-menu'), _vm._v(" "), _c('div', {
      staticClass: "mdl-js-button mdl-js-ripple-effect flex-block--bg-ripple"
    }), _vm._v(" "), _c('div', {
      staticClass: "avatar avatar--folder grey",
      class: item.iconColor
    }, [_c('div', [_c('i', {
      staticClass: "zmdi",
      class: item.icon
    })])]), _vm._v(" "), _c('div', {
      staticClass: "flex-block__content"
    }, [_c('div', {
      staticClass: "flex-block__top"
    }, [_c('span', {
      staticClass: "flex-block__title"
    }, [_vm._v(_vm._s(item.name) + " "), (item.isLoading) ? _c('span', {
      staticClass: "flex-block__speed"
    }, [_vm._v("123KB/s")]) : _vm._e()]), _vm._v(" "), (item.isLoading) ? _c('div', {
      staticClass: "flex-block__progress"
    }, [_c('progress', {
      attrs: {
        "max": "100",
        "value": "80"
      ...
      staticClass: "flex-block__prog-close mdl-js-button mdl-js-ripple-effect",
      on: {
        "click": function($event) {
          _vm.abortLoading(key)
        }
      }
    }, [_c('i', {
      staticClass: "zmdi zmdi-close-circle-o"
    })])]) : _vm._e(), _vm._v(" "), (!item.isLoading) ? _c('span', {
      staticClass: "flex-block__additional"
    }, [_vm._v(_vm._s(item.additional))]) : _vm._e()]), _vm._v(" "), (!item.isLoading) ? _c('div', {
      staticClass: "flex-block__bottom"
    }, [_c('span', {
      staticClass: "flex-block__desc"
    }, [_vm._v("Date: " + _vm._s(item.timestamp.friendly) + " ")]), _vm._v(" "), _c('span', {
      staticClass: "flex-block__badge"
    }, [_vm._v("Size: " + _vm._s(item.size.friendly) + " MB")])]) : _vm._e()]), _vm._v(" "), ((item.hasMenu && !item.isLoading)) ? _c('div', {
      staticClass: "flex-block__extra",
      class: {
        'dropdown-active': item.isDropdownActive
      }
    }, [_c('div', {
      staticClass: "btn-more mdl-js-button mdl-js-ripple-effect",
      on: {
        "dblclick": _vm.stopPropagation,
        "click": function($event) {
          _vm.toggleItemMenu(item, $event)
        }
      }
    }, [_c('i', {
      staticClass: "zmdi zmdi-more-vert"
    })]), _vm._v(" "), _c('div', {
      staticClass: "files-ddown files-ddown--item",
      class: {
        'is-visible': item.isDropdownActive
      }
    }, [_c('div', {
      staticClass: "ddown__arrow"
    }), _vm._v(" "), _c('ul', {
      staticClass: "ddown__menu"
    }, [_c('li', {
      staticClass: "ddown__header",
      on: {
        "click": function($event) {
          _vm.openItem(item)
        }
      ...
      staticClass: "mdl-js-button mdl-js-ripple-effect",
      attrs: {
        "href": "#"
      }
    }, [_c('i', {
      staticClass: "zmdi zmdi-folder-outline",
      staticStyle: {
        "color": "#2196f3"
      }
    }), _c('span', [_vm._v("Open")])])]), _vm._v(" "), _c('li', {
      on: {
        "click": function($event) {
    ...
    }), _c('span', [_vm._v("Download")])])]), _vm._v(" "), _c('li', {
      on: {
        "click": function($event) {
          _vm.copyItem(item)
        }
      ...
      staticClass: "zmdi zmdi-copy"
    }), _c('span', [_vm._v("Copy")])])]), _vm._v(" "), _c('li', {
      on: {
        "click": function($event) {
          _vm.cutItem(item)
        }
      ...
      staticClass: "zmdi zmdi-scissors"
    }), _c('span', [_vm._v("Cut")])])]), _vm._v(" "), _c('li', {
      on: {
        "click": function($event) {
          _vm.pasteItem(item)
        }
      ...
      staticClass: "zmdi zmdi-file-plus"
    }), _c('span', [_vm._v("Paste")])])]), _vm._v(" "), _c('li', {
      staticClass: "ddown__footer has-submenu",
      on: {
        "click": function($event) {
          _vm.removeItem(item)
        }
    ...
    }), _c('span', [_vm._v("Delete")])])])])])]) : _vm._e()], 1) : _vm._e()
  }))], 1), _vm._v(" "), _c('div', {
    staticClass: "files-section"
  }, [((_vm.filesPresent && _vm.searchFilter.length > 0)) ? _c('p', {
    staticClass: "files-label"
  }, [_vm._v("FILES:")]) : _vm._e(), _vm._v(" "), _c('transition-group', {
    staticClass: "item-container",
    attrs: {
      "name": "fade",
      "tag": "p"
    ...
    return (item.type === 'file') ? _c('div', {
      ...
      attrs: {
        "data-key": key,
        "data-selected": _vm.areSelected.length > 0 ? _vm.areSelected.length : false
      },
      on: {
        "click": [_vm.itemMenuOff, function($event) {
          $event.preventDefault();
          if (!$event.ctrlKey) { return null; }
          _vm.selectItem(item)
        }],
        ...
        "contextmenu": function($event) {
          $event.preventDefault();
          _vm.fireCtxMenuFiles($event, item)
        }
      }
    }, [_c('div', {
      staticClass: "mdl-js-button mdl-js-ripple-effect flex-block--bg-ripple"
      ...
      staticClass: "flex-block__speed"
    }, [_vm._v("251KB/s")]) : _vm._e()]), _vm._v(" "), (item.isLoading) ? _c('div', {
      staticClass: "flex-block__progress"
    }, [_c('progress', {
      attrs: {
        "max": "100",
    ...
    }), _c('span', [_vm._v("Delete")])])])])])]) : _vm._e()]) : _vm._e()
  }))], 1)], 1), _vm._v(" "), _vm._m(2)]), _vm._v(" "), _c('notification-area'), _vm._v(" "), (_vm.areSelected.length > 0) ? _c('div', {
    staticClass: "card__footer"
  }, [_c('selected-menu')], 1) : _vm._e()], 1)
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('dialog', {
    staticClass: "mdl-dialog ar-dialog",
    attrs: {
      "data-dialog-id": "wf-rename"
    }
  }, [_c('div', {
    staticClass: "mdl-dialog__canvas"
  }, [_c('div', {
    staticClass: "mdl-dialog__header"
  }, [_c('span', {
    staticClass: "mdl-dialog__title"
  }, [_vm._v("Rename")]), _vm._v(" "), _c('a', {
    staticClass: "mdl-js-button mdl-js-ripple-effect close",
    attrs: {
      "href": "#"
    }
  }, [_c('i', {
    ...
    staticClass: "btn btn--s-small btn--primary mdl-js-button mdl-js-ripple-effect accept mr8",
    attrs: {
      "type": "button"
    }
  }, [_vm._v("Accept")]), _vm._v(" "), _c('button', {
    staticClass: "btn btn--s-small btn--dark mdl-js-button mdl-js-ripple-effect close",
    attrs: {
      "type": "button"
    }
  }, [_vm._v("Cancel")])])])])
  ...
  return _c('dialog', {
    ...
    staticClass: "mdl-dialog__title"
  }, [_vm._v("Directory Name:")]), _vm._v(" "), _c('a', {
    staticClass: "mdl-js-button mdl-js-ripple-effect close",
    attrs: {
      "href": "#"
    }
  ...
  return _c('div', {
    staticClass: "drag-and-drop-legend"
  }, [_c('i', {
    staticClass: "zmdi zmdi-cloud-upload"
  }), _vm._v(" "), _c('span', [_vm._v("Drag and drop to upload file to this directory")])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-92748874", module.exports)
  }
}
...
var update = __webpack_require__(20)("7b30a546", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-92748874\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/less-loader/dist/index.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./widget_files.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-92748874\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/less-loader/dist/index.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./widget_files.vue");
