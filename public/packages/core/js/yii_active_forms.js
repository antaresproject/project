/*! Antares_Front-End - v0.7.1 - 2016-08-09 */!function($) {
    var getAFValue = function(o) {
        var type, c = [];
        if (o.length) return "span" === o[0].tagName.toLowerCase() ? (o.find(":checked").each(function() {
            c.push(this.value);
    ...
    $.fn.yiiactiveform = function(options) {
        ...
        }), hasError ? ($error.html(messages[attribute.id][0]), $container.addClass(attribute.errorCssClass)) : (attribute.enableAjaxValidation || attribute.clientValidation) && $container.addClass(attribute.successCssClass), 
        ...
        if (void 0 !== settings.summaryID) {
            if (messages) {
                ...
                for (var i in settings.attributes) settings.attributes[i].summary && summaryAttributes.push(settings.attributes[i].id);
                $.each(settings.attributes, function() {
        ...
        }), !needAjaxValidation || settings.submitting && !$.isEmptyObject(messages)) return void (settings.submitting ? setTimeout(function() {
