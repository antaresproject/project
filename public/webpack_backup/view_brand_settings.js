            ...
            change: function change(value, opacity) {
                ...
                if ($(this).closest('.cp-brand--primary').length) {
                    ...
                    'aside.main-sidebar ul.main-menu .submenu.submenu--system section.section--2col .submenu__content .submenu__content-right .datarow .datarow__right i', '.main-menu .is-active .icon, .main-menu .is-active i, .main-menu .is-active .text', '.ddown.ddown--brand .ddown__menu li.is-selected .flex-block, .ddown.ddown--brand .ddown__menu li.is-selected .flex-block .flex-block__title', '#table-ma', '.timeline li.timeline__entry--ok:before', '.timeline li a', '.ddown.ddown--brand .ddown__menu li.is-selected .flex-block', '.ddown.ddown--brand .ddown__menu li.is-selected .flex-block .flex-block__title'],
                        primaryTargetsBackground = ['.app-content:before', '.switch .switch-checkbox:checked + .switch-container', '.app-content__footer .btn--submit', '.menu-aside-container', '.app-content:before',
                    //new
                    ...
                    //new
                    'aside.main-sidebar.main-menu.main-menu--brand li:nth-child(1).submenu-open > a:after', 'aside.main-sidebar ul.main-menu li:nth-child(2).submenu-open > a:after'],
                ...
                if ($(this).hasClass('cp-brand__p-sgl--left')) {
                    ...
                    if ($(this).closest('.cp-brand--primary').length) {
                        ...
                        var primaryLeft = 'primary-left',
                            primaryLeftTargets = ['.menu-aside li a span, .menu-aside li a i', '.breadcrumbs > li:last-child .ddown__init a, .breadcrumbs .ddown .ddown__content .ddown__arrow:after,.breadcrumbs .ddown .ddown__init.ddown__init--white:after, .ddown .ddown__init.ddown__init--white i', '.item-grp  i', '.btn.btn--brand', '.ddown .ddown__init.ddown__init--white:after, .ddown .ddown__init.ddown__init--white i'];
                    ...
                    if ($(this).closest('.cp-brand--secondary').length) {
                        ...
                        var secondartLeft = 'secondary-left',
                            secondartLeftTargets = ['aside.main-sidebar ul.main-menu > li > a', 'aside.main-sidebar ul.main-menu > li > a .icon', 'aside.main-sidebar ul.main-menu > li > a i'];
                    ...
                    if ($(this).closest('.cp-brand--secondary').length) {
                        ...
                        var secondaryRightTargets = ['aside.main-sidebar ul.main-menu > li > a:hover', 'aside.main-sidebar ul.main-menu > li > a:hover .icon', 'aside.main-sidebar ul.main-menu > li > a:hover i', 'aside.main-sidebar ul.main-menu > li.hovered .text', 'aside.main-sidebar ul.main-menu > li.hovered .icon', 'aside.main-sidebar ul.main-menu > li.hovered i'];
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(12), __webpack_require__(227));
  else if (typeof define == "function" && define.amd) // AMD
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(12), __webpack_require__(228));
  else if (typeof define == "function" && define.amd) // AMD
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(12), __webpack_require__(542));
  else if (typeof define == "function" && define.amd) // AMD
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(12), __webpack_require__(544), __webpack_require__(226));
  else if (typeof define == "function" && define.amd) // AMD
...
__webpack_require__(2)(__webpack_require__(940))
